...
namespace CsgoHaxOverlay
{
    ...
    {
        // READ FLAGS
        public static uint ProcessVmRead = 0x0010;
        public static uint ProcessVmWrite = 0x0020;
        public static uint ProcessVmOperation = 0x0008;
        public static uint PageReadwrite = 0x0004;

        // WINDOW FLAGS
        public static uint WsMaximize = 0x1000000;
        public static uint WsCaption = 0xC00000;      // WS_BORDER or WS_DLGFRAME  
        public static uint WsBorder = 0x800000;
        public static uint WsVisible = 0x10000000;
